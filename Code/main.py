...
<LieuScreen>:
    ...
    MDLabel: 
        text: "Faites attention à [b]votre propre sécurité.[/b]"
        pos_hint: {"center_x":0.5, "center_y":0.525}
        markup: True
        halign: "center"
        font_style: "Body1"
...
<HemoScreen1>:
    ...
    MDLabel: 
        text: "2. Si vous voyez un corps étranger, [b]n'appuyez et ne l'enlevez pas.[/b]"
        pos_hint: {"center_x":0.5, "center_y":0.5}
        halign: "center"
        markup: True
        font_style: "Body2"
    ...
    MDLabel: 
        text: "3. Arrêtez le saignement en appuyant sur la blessure."
        pos_hint: {"center_x":0.5, "center_y":0.4}
        halign: "center"
        font_style: "Body2"
        font_size:"15dp"
...
<HemoScreen2>:
    ...
    MDLabel:
        text: "7. Appelez les secours et indiquez: la location, l’âge, le sexe et l’état de la victime."
    ...
    MDLabel:
        text: "8. Surveillez-la et ne lui donnez pas à boire. Si elle perd conscience, adoptez la démarche nécessaire. "
...
<EtouffWScreen>:
    ...
    MDLabel: 
        text: "2. [b]ne peut pas[/b] tousser ou parler."
        pos_hint: {"center_x":0.5, "center_y":0.5}
        halign: "center"
        markup: True
        font_style: "Body2"
...
<EtouffPScreen>:
    ...
    MDLabel: 
        text: "2. Encouragez la à tousser jusqu’à ce que le problème soit réglé."
        pos_hint: {"center_x":0.5, "center_y":0.5}
        halign: "center"
        font_style: "Body2"
        font_size:"16dp"
...
<EtouffA1Screen>:
    ...
    MDLabel:
        text: "1. Appelez les secours et indiquez: la location, l’âge, le sexe et l’état de la victime."
        pos_hint: {"center_x": 0.5, "center_y": 0.72}
        halign: "center"
        font_style: "Body2"
        font_size:"14dp"
...
<EtouffA2Screen>:
    ...
    MDLabel:
        text: "5. Placez votre deuxième main par dessus votre poing."
    ...
    MDLabel:
        text: "6. Tirez vers vous 5 fois d’un coup sec."
        pos_hint: {"center_x": 0.5, "center_y": 0.58}
        halign: "center"
        font_style: "Body2"
        font_size:"14dp"
    ...
    MDLabel:
        text: "7. Alternez les 5 tapes et 5 pressions."
...
<EtouffB2Screen>:
    ...
    MDLabel:
        text: "1. Retournez le bébé doucement sur votre cuisse, en maintenant et gardant sa tête vers le bas."
    ...
    MDLabel:
        text: "2. Placez deux doigts de la même main sur le sternum."
    ...
    MDRectangleFlatButton: 
        ...
        text_color: (0,0,0,1)
        padding: [25,0]
        on_press: root.manager.current = "Etouff5b"
...
<EtouffOE2Screen>:
    ...
    MDLabel:
        text: "4. Placez vous derrière la victime, et placez votre poing au milieu de son sternum."
...
<VCScreen>:
    ...
    MDLabel: 
        text: "1. Ressent une forte douleur à la poitrine."
...
<AVCScreen>:
    ...
    MDLabel:
        text: "1. Appelez les secours au plus vite et indiquez: la location, l’âge, le sexe et l’état de la victime."
    ...
    MDLabel:
        text: "4. Surveillez-la constamment, et rassurez-la."
    ...
    MDLabel:
        text: "5. Si elle perd conscience, adoptez les gestes nécessaires."
        pos_hint: {"center_x": 0.5, "center_y": 0.31}
        halign: "center"
        font_style: "Body2"
        font_size: "16dp"
...
<CriseScreen>:
    ...
    MDLabel:
        text: "1. Appelez les secours et indiquez: la location, l’âge, le sexe et l’état de la victime."
        pos_hint: {"center_x": 0.5, "center_y": 0.685}
        halign: "center"
        font_style: "Body2"
        font_size:"16dp"
        theme_text_color: "Custom"
    ...
    MDLabel:
        text: "3. Desserez-lui ses habits (exemple: déboutonner la chemise)."
        pos_hint: {"center_x": 0.5, "center_y": 0.47}
        halign: "center"
        font_style: "Body2"
        font_size:"16dp"
    ...
    MDLabel:
        text: "4. Surveillez-la et rassurez-la."
...
<ConsScreen>:
    name:"Cons"
    MDLabel: 
        text: "Vérifiez l’état de conscience"
        pos_hint: {"center_x":0.5, "center_y":0.7}
        halign: "center"
        font_style: "H6"
        font_size:"40"
    ...
    MDLabel: 
        text: "1. Répond-t-elle à la [b]stimulation verbale ?[/b]"
        pos_hint: {"center_x":0.5, "center_y":0.575}
        halign: "center"
        markup: True
        font_style: "Body1"
    ...
    MDLabel: 
        text: "2. Répond-t-elle à la [b]stimulation douleureuse ?[/b]"
        pos_hint: {"center_x":0.5, "center_y":0.475}
        halign: "center"
        markup: True
        font_style: "Body1"
...
<RespiScreen1>:
    ...
    MDLabel: 
        text: "2. Basculez la tête en arrière."
        pos_hint: {"center_x":0.5, "center_y":0.6}
        halign: "center"
        font_style: "Body1"
        font_size: "35"
...
<RespiScreen2>:
    ...
    MDLabel: 
        text: "1. Approchez vous de sa bouche et écoutez: [b]Entendez-vous une respiration ?[/b]"
        pos_hint: {"center_x":0.5, "center_y":0.6}
        halign: "center"
        markup: True
        font_style: "Body1"
    ...
    MDLabel: 
        text: "2. Mettez votre main sur son abdomen: [b]Sentez-vous un mouvement ?[/b]"
        pos_hint: {"center_x":0.5, "center_y":0.45}
        halign: "center"
        markup: True
        font_style: "Body1"
...
<PLS1>:
    ...
    MDLabel: 
        text: "3. Prenez le bras [b]le plus proche[/b] de vous et placez-le [b]à angle droit[/b] par rapport à la victime."
        pos_hint: {"center_x":0.5, "center_y":0.58}
        halign: "center"
        markup: True
        font_style: "Body2"
...
<PLS2>:
    ...
    MDLabel: 
        text: "4. Pliez vers le haut le genou [b]le plus loin de vous[/b]."
        pos_hint: {"center_x":0.5, "center_y":0.75}
        halign: "center"
        font_style: "Body1"
        font_size: "35"
...
<PLS3>:
    ...
    MDLabel: 
        text: "5. Placez une main sur le genou plié, et l’autre sur l’épaule non-étendue."
    ...
    MDLabel: 
        text: "6. Ramenez le corps vers vous, pour mettre la victime sur le côté."
    ...
    MDLabel: 
        text: "8. Si elle arrête de respirer, adoptez les gestes nécessaires."
        pos_hint: {"center_x":0.5, "center_y":0.545}
        halign: "center"
        font_style: "Body1"
        font_size:"16dp"
...
<CPRA1>:
    ...
    MDLabel: 
        text: "2. Envoyez une personne chercher un AED, pendant que vous suivez les instructions sur l’écran."
...
<CPRA2>:
    ...
    MDLabel: 
        text: "5. Mettez vous à genoux à la hauteur de ses épaules."
        pos_hint: {"center_x":0.5, "center_y":0.8}
        halign: "center"
        font_style: "Body2"
        theme_text_color: "Custom"
    ...
    MDLabel: 
        text: "6. Placez [b]le talon de votre main[/b] sur le sternum."
        pos_hint: {"center_x":0.5, "center_y":0.72}
        halign: "center"
        markup: True
        font_style: "Body2"
    ...
    MDLabel: 
        text: "7. Placez [b]l’autre main[/b] au-dessus de la première."
        pos_hint: {"center_x":0.5, "center_y":0.64}
        halign: "center"
        markup: True
        font_style: "Body2"
    ...
    MDLabel: 
        text: "8. Utilisez le poids de votre corps pour compresser, en gardant [b]les bras tendus[/b], en angle droit."
        pos_hint: {"center_x":0.5, "center_y":0.55}
        halign: "center"
        markup: True
        font_style: "Body2"
...
<CPRC>:
    ...
    MDLabel: 
        text: "1. Appuyez vite et fort au rythme de [b]'Staying alive' ou 'Uptown Funk'[/b], en laissant le thorax revenir à sa position initiale à chaque fois."
    ...
    MDLabel: 
        text: "2. Essayez de changer de masseur [b]toutes les 2 minutes.[b]"
    ...
    MDLabel: 
        text: "3. N’arrêtez le massage seulement si les ambulanciers ou l'AED vous le demandent, ou si vous êtes trop fatigué."
    ...
    MDLabel: 
        text: "4. Pour localiser un AED, cliquez [b]'AED'[/b]. Si vous en avez déjà un, cliquez [b]'Consignes'[/b]."
        pos_hint: {"center_x":0.5, "center_y":0.3}
        markup: True
        halign: "center"
        font_style: "Body2"
...
<CPRE2>:
    ...
    MDLabel: 
        text: "6. Placez [b]une main[/b] sur le sternum."
    ...
    MDLabel: 
        text: "7. Placez l’autre main sur [b]votre[/b] cuisse."
        pos_hint: {"center_x":0.5, "center_y":0.68}
        halign: "center"
        markup: True
        font_style: "Body2"
    ...
    MDLabel: 
        text: "8. Utilisez le poids de votre corps pour compresser, en gardant [b]votre bras[/b] tendu, en angle droit."
        pos_hint: {"center_x":0.5, "center_y":0.59}
        halign: "center"
        font_style: "Body2"
        markup: True
...
<CPRB2>:
    ...
    MDLabel: 
        ...
        pos_hint: {"center_x":0.5, "center_y":0.735}
        halign: "center"
        font_style: "Body1"
        font_size: "15dp"
        theme_text_color: "Custom"
    ...
    MDLabel: 
        text: "6. Placez [b]deux doigts de la même main[/b] (ou les deux pouces) sur le bas du sternum, et compressez."
        pos_hint: {"center_x":0.5, "center_y":0.62}
        halign: "center"
        markup: True
        font_style: "Body1"
...
<AED1>:
    ...
    MDLabel:
        text: "3. Placez les électrodes comme ci-dessous."
...
<AED2>:
    ...
    MDLabel: 
        text: "4. Pendant que la machine évalue, [b]arrêtez le massage et ne touchez plus la victime[/b]."
        pos_hint: {"center_x":0.5, "center_y":0.72}
        halign: "center"
        markup: True
        font_style: "Body2"
    ...
    MDLabel: 
        text: "5. Si un choc est nécessaire, éloignez vous de la victime, et [b]criez: 'PERSONNE TOUCHE LA VICTIME'[/b]."
        pos_hint: {"center_x":0.5, "center_y":0.6}
        halign: "center"
        markup: True
        font_style: "Body2"
...
<Screen3>:
    ...
    MDFloatingActionButton:
        ...
        text_color: app.theme_cls.primary_color
        pos_hint: {"center_x": 0.3, "center_y": 0.065}
    ...
    MDFloatingActionButton:
        ...
        text_color: app.theme_cls.primary_color
        pos_hint: {"center_x": 0.7, "center_y": 0.065}
        on_press: app.root.current = "AED1"
        md_bg_color: (1, 1, 1, 1)
        elevation_normal: 12
"""
...
sm.add_widget(EtouffB3Screen(name="Etouff5b"))
